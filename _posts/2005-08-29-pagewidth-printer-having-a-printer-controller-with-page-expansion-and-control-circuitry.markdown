...
title: Pagewidth printer having a printer controller with page expansion and control circuitry
abstract: A pagewidth printer includes a pagewidth printhead. A feed mechanism feeds print media through the printhead so that the printhead can carry out a pagewidth printing operation on the print media. A printer controller controls operation of the printhead. The controller has a printed circuit board that includes a central processor. The central processor has a bus. A data input interface is connected to the bus so that the bus can receive compressed and encoded page data from a computer-based machine connected to the data input interface. Page data expansion and decoding circuitry is connected to the bus and configured to expand and decode the compressed and encoded page data. A printhead interface communicates print page data to the printhead. Processing circuitry controls operation of components of the printer controller.
url: http://patft.uspto.gov/netacgi/nph-Parser?Sect1=PTO2&Sect2=HITOFF&p=1&u=%2Fnetahtml%2FPTO%2Fsearch-adv.htm&r=1&f=G&l=50&d=PALL&S1=07108346&OS=07108346&RS=07108346
...
---
This is a Continuation of Ser. No. 11 003 365 filed on Dec. 6 2004 now U.S. Pat. No. 7 025 434 which is a Continuation of Ser. No. 10 636 267 filed on Aug. 8 2003 now issued U.S. Pat. No. 6 843 545 which is a Divisional of Ser. No. 09 436 747 filed Nov. 9 1999 now issued U.S. Pat. No. 6 687 022 all of which are herein incorporated by reference.
...
Given a 4 bit halftoned color CMYKand a 1 bit black layer opacity K the composite and as defined in Table 22.
